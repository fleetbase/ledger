...
Ledger extension for invoicing, accounting, wallets, transactions, payment gateways, and financial records.

## Allowed Work

- Bug fixes for invoicing, wallets, transactions, gateways, accounting records, and Ledger UI workflows.
- Small tests, documentation updates, and compatibility fixes that preserve financial data semantics.
- API resource, validation, and schema updates when paired with documentation/spec checks.

## Restricted Work

- Financial calculation, wallet balance, transaction, gateway, or settlement changes without explicit human approval.
- Data migrations or destructive accounting changes without review.
